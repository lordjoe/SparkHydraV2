...
public class JavaBigDataWordCountTests implements Serializable {
    ...
    public static <K> List<K>  asList(Iterator<K> from)  {
    ...
    public void testVariants() throws Exception {
        ...
        Iterator<String> the = caseVariationFunction.call("THE");
        while(the.hasNext())  {
            String s = the.next();
        ...
        Iterator<String> four = caseVariationFunction.call("FOUR");
        List<String> l16 = asList(four);
        Assert.assertEquals(16, l16.size());
        Iterator<String> abcde = caseVariationFunction.call("ABCDE");
        List<String> l32 = asList(abcde);
