...
//        statistics.setData("Max Mass Fragments", Long.toString(MaxFragments));
    ...
    private class ReMapMeasuredSpectraToBins<T extends IMeasuredSpectrum> extends AbstractLoggingPairFlatMapFunction<T, BinChargeKey, T> {
        ...
        @Override
        public Iterator<Tuple2<BinChargeKey, T>> doCall(final T spec) throws Exception {
    ...
    public JavaPairRDD<BinChargeKey, IPolypeptide > mapSplitFragmentsToBinHash(JavaRDD<IPolypeptide> inp,  final MapOfLists<Integer, BinChargeKey> splitKeys) {
        JavaPairRDD<BinChargeKey, HashMap<String, IPolypeptide>> mappedByhash = binMapper.mapSplitFragmentsToBinHash(inp, splitKeys);
          JavaPairRDD<BinChargeKey, IPolypeptide> binnedPeptides = mappedByhash.flatMapToPair(new PairFlatMapFunction<Tuple2<BinChargeKey, HashMap<String, IPolypeptide>>, BinChargeKey, IPolypeptide>() {
            @Override
            public Iterator<Tuple2<BinChargeKey, IPolypeptide>> call(Tuple2<BinChargeKey, HashMap<String, IPolypeptide>> v) throws Exception {
...
//        });
    ...
    public static class ScoredScansToIds extends AbstractLoggingPairFlatMapFunction<Map<String, IScoredScan>, String, IScoredScan> {
        @Override
        public Iterator<Tuple2<String, IScoredScan>> doCall(final Map<String, IScoredScan> t) throws Exception {
    ...
    public static class ScoreScansByCharge extends AbstractLoggingFlatMapFunction<Tuple2<IPolypeptide, IMeasuredSpectrum>, IScoredScan> {
         ...
         */
        @Override
        public Iterator<IScoredScan> doCall(final Tuple2<IPolypeptide, IMeasuredSpectrum> t) throws Exception {
    ...
    public static class ScoreScansByChargeFlatMap extends AbstractLoggingFlatMapFunction<Iterator<Tuple2<BinChargeKey, Tuple2<IMeasuredSpectrum, IPolypeptide>>>, IScoredScan> {
        ...
        @Override
        public Iterator<IScoredScan> doCall(final Iterator<Tuple2<BinChargeKey, Tuple2<IMeasuredSpectrum, IPolypeptide>>> t) throws Exception {
            List<IScoredScan> holder = new ArrayList<IScoredScan>();
    ...
    public static class MapBinChargeTupleToSpectrumIDTuple<T extends IMeasuredSpectrum> extends AbstractLoggingPairFlatMapFunction<Tuple2<BinChargeKey, Tuple2<IPolypeptide, T>>, String, Tuple2<IPolypeptide, T>> {
        @Override
        public Iterator<Tuple2<String, Tuple2<IPolypeptide, T>>> doCall(final Tuple2<BinChargeKey, Tuple2<IPolypeptide, T>> t) throws Exception {
    ...
    public class ScoreSpectrumAgainstAllPeptides extends AbstractLoggingFlatMapFunction<Iterator<Tuple2<String, Tuple2<IPolypeptide, IMeasuredSpectrum>>>, IScoredScan> {
        @Override
        public Iterator<IScoredScan> doCall(final Iterator<Tuple2<String, Tuple2<IPolypeptide, IMeasuredSpectrum>>> t) throws Exception {
