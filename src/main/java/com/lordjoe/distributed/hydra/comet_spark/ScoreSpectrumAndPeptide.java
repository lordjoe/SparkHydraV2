...
import com.lordjoe.distributed.spark.accumulators.MemoryUseAccumulator;
import com.lordjoe.distributed.spark.accumulators.MemoryUseAccumulatorAndBinSize;
...
public class ScoreSpectrumAndPeptide extends AbstractLoggingFlatMapFunction<Tuple2<IPolypeptide, CometScoredScan>, IScoredScan> {
    ...
    @Override
    public Iterator<IScoredScan> doCall(Tuple2<IPolypeptide, CometScoredScan> inp) throws Exception {
