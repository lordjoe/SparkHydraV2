    ...
    public static class PairCounter implements Comparable<PairCounter> {
        ...
        public int compareTo(final PairCounter o) {
            if (o.product == product)
                return 0;
            else return o.product < product ? 1 : -1;
        }
...
//        }
        ...
        JavaPairRDD<String, Iterable<IScoredScan>> byId = bestScores.groupBy(new Function<IScoredScan, String>() {
            @Override
            public String call(IScoredScan v1) throws Exception {
                return v1.getId();
            }
        });

        throw new UnsupportedOperationException("Fix This"); // ToDo    This section needs to be updated
//        JavaPairRDD<String, Object> stringObjectJavaPairRDD = byId.combineByKey(new AbstractLoggingFunction<Iterable<IScoredScan>, Object>() {
//            @Override
//            public Object doCall(Iterable<IScoredScan> v1) throws Exception {
//                return null;
//            }
//        });
//
...
//
//        Encoder<String> string_evidence = Encoders.bean(String.class);
//        KeyValueGroupedDataset<String, CometScoringResult> byId = scoreSet.groupByKey(new AbstractLoggingMapFunction<CometScoringResult, String>() {
//            @Override
//            public String doCall(CometScoringResult v1) throws Exception {
//                return v1.getId();
//            }
//
//
...
//         */
//        AbstractLoggingReduceFunction<CometScoringResult> abstractLoggingReduceFunction = new AbstractLoggingReduceFunction<CometScoringResult>() {
//            @Override
...
//        RelationalGroupedDataset byId = scoreSet.groupBy(id);
//           JavaRDD<CometScoringResult> cometScoringResultJavaRDD1 = scoreSet.javaRDD();
//          Dataset<Tuple2<Row, CometScoringResult>> reduce = cometScoringResultJavaRDD1.reduce(abstractLoggingReduceFunction);
//
