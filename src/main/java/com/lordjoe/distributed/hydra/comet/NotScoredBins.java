 ...
 * @date 5/28/2015
 */
public class NotScoredBins extends IAccumulator<NotScoredBins> {
     ...
     * Use static method empty
     */
    private NotScoredBins(NotScoredBins copy) {
        usage.addAll(copy.usage);
    }
    ...
    public void add(NotScoredBins added) {
    ...
    @Override
    public IAccumulator<NotScoredBins> copy() {
        return new NotScoredBins(this);
    }

    @Override
    public void merge(AccumulatorV2<NotScoredBins, NotScoredBins> other) {
          add((NotScoredBins)other) ;
    }
