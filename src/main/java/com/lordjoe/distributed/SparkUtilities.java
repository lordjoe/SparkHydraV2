...
//            System.err.println("timeout = " + option.get());
        ...
        BasicSparkAccumulators.createInstance(ret);
...
//        // set all properties in the SparkProperties file
    ...
    public static final StorageLevel DEFAULT_STORAGE_LEVEL = StorageLevel.MEMORY_AND_DISK_SER_2(); //StorageLevel.MEMORY_AND_DISK(); // StorageLevel.DISK_ONLY(); //  StorageLevel.MEMORY_AND_DISK(); //StorageLevel.OFF_HEAP(); //
