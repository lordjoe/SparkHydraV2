...
public class StatisticalWordCount {
    ...
    public static void main(final String[] args) {
        ...
        // Make two accumulators using Statistics
          sc.register(new Statistics(),"Line Statistics" );
        final Statistics lineStats =    new Statistics();
        sc.register(lineStats,"Line Statistics" );
        ...
        JavaRDD<String> words = lines.flatMap(new FlatMapFunction<String, String>() {
            ...
            public Iterator<String> call(final String s) throws Exception {
                ...
                totalLetters.add((long)s.length());
