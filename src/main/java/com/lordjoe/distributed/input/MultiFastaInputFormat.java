 ...
 * Date: 9/24/2014
 */
public class MultiFastaInputFormat extends FileInputFormat<String, String> implements Serializable {
    ...
    public RecordReader<String, String> createRecordReader(InputSplit split,
        ...
        if (isSplitReadable(split))
            return new MultiFastaFileReader();
        else
     ...
     */
    public   class MultiFastaFileReader extends RecordReader<String, String> {
        ...
        private boolean readNextField() throws IOException  {
            ...
            if(str.startsWith(">sp|P85731|PVK2_PERVR Periviscerokinin-2 OS=Perisphaeria virescens PE=1 SV=1"))
                m_Data.setLength(0); // break here
            m_Valuex.append(str);
            m_Data.setLength(0); // clear the buffer
