...
//    public static final SAXParserFactory SAX_FACTORY = getSaxParserFactory();
    ...
    */
    ...
    public static XMLReader getXMLParser()
    {
        ...
        try {
            TheParser = XMLReaderFactory.createXMLReader();
          }
        catch (Exception ex) {
           throw new RuntimeException(ex);
        }
...
//	}
    ...
    */
    ...
    public static boolean testTagParse(String XMLText)
    {
        ...
        InputStream in = new ByteArrayInputStream(XMLText.getBytes(Charset.forName("UTF-8")));
    ...
    */
    ...
    {
        InputStream in = null;
        InputStream is = new ByteArrayInputStream(id.getBytes(Charset.forName("UTF-8")));
    ...
    */
    @SuppressWarnings("UnusedDeclaration")
    public static Document getStringDOM(String id,XMLReader parser)
    {
          InputStream in = new ByteArrayInputStream(id.getBytes(Charset.forName("UTF-8")));
          return(getStreamDOM(in,parser));
    }
    ...
    */
    @SuppressWarnings(value = "deprecated")
    public static Document getFileDOM(String id,XMLReader parser)
    {
        InputStream in = null;
        int index = 0;
    ...
    */
    @SuppressWarnings(value = "deprecated")
    public static Document getURLDOM(String id,XMLReader parser)
    {
        InputStream in = null;
        int index = 0;
    ...
    */
    ...
    @SuppressWarnings(value = "deprecated")
    public static Document getStreamDOM(InputStream in,XMLReader parser)
    {
	    InputSource  input;
	    Document doc;
	    if(parser == null)
