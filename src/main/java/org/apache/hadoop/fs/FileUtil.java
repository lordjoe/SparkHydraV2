...
public class FileUtil {
  ...
  private static void checkDependencies(FileSystem srcFS, 
                                        ...
                                        throws IOException {
    if (srcFS == dstFS) {
      String srcq = src.makeQualified(srcFS.getUri(),src).toString() + Path.SEPARATOR;
      String dstq = dst.makeQualified(dstFS.getUri(),dst).toString() + Path.SEPARATOR;
  ...
  private static void unTarUsingJava(File inFile, File untarDir,
    ...
    try {
      ...
      IOUtils.cleanupWithLogger(null, tis, inputStream);
    }
  }
  ...
  public static int symLink(String target, String linkname) throws IOException{
    ...
    if (Shell.WINDOWS  && targetFile.isFile()) {
      try {
...
//      }
  ...
  public static String createJarWithClassPath(String inputClassPath, Path pwd,
    ...
    try {
      ...
      IOUtils.cleanupWithLogger(null, jos, bos, fos);
    }
