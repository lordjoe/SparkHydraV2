...
public final class
    ...
    public static void main(String[] args) throws Exception {
      ...
      final Statistics letterStats =   Statistics.ZERO;
        final LongAccumulator totalWords = sc.longAccumulator("Word Statistics" );
  ...
  //     lines = SparkUtilities.persistAndCount("lines",lines);
   ...
   //     lines = lines.repartition(NUMBER_PARTITIONS);
        ...
        JavaPairRDD<String, Integer> ones = words.flatMapToPair(new PairFlatMapFunction<String, String, Integer>() {
            @Override
            public Iterator<Tuple2<String, Integer>> call(final String t) throws Exception {
...
//        });
        ...
        JavaRDD<WordNumber> answer = sorted.mapPartitions(
                new FlatMapFunction<Iterator<Tuple2<String, Integer>>, WordNumber>() {
                    @Override
                    public Iterator<WordNumber> call(final Iterator<Tuple2<String, Integer>> t) throws Exception {
                        int sum = 0;
                        String word = null;
